...
import { ReservationDetailComponent as ReservationDetailComponent }  from './reservation-detail/reservation-detail.component';
...
@NgModule({
  imports: [
    ...
    //   ReservationService, { dataEncapsulation: false }
    // )
  ],
  declarations: [
    AppComponent,
